...
import mg.x261.myauthentication.databinding.ActivityMainBinding;

public class MainActivityUsingBinding extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.generatePasscodeButton.setOnClickListener(v -> onClickGeneratePasscode());
    }
    ...
    private void initSharedPreferences() {
        ...
        if (studentId == null || email == null) {
            ...
            binding.studentIdEditText.setText(studentId);
    ...
    private void startMainActivityLogged() {
        Intent intent = new Intent(MainActivityUsingBinding.this, MainActivityLogged.class);
        startActivity(intent);
        finish();
    }

    private void showPasscodeDialog(String passcode, String expirationDate) {
        AlertDialog.Builder builder = new AlertDialog.Builder(MainActivityUsingBinding.this);
    ...
    private void showToast(int stringResId) {
        Toast.makeText(MainActivityUsingBinding.this, stringResId, Toast.LENGTH_SHORT).show();
    }

    private void showToast(String message) {
        Toast.makeText(MainActivityUsingBinding.this, message, Toast.LENGTH_SHORT).show();
    }
